...
<div class="panel panel-default">
	<div class="panel-body">
		<div class="row">
			<div class="col-lg-6">
				<form method="POST" action="{{action('BecaController@updatePasoBeca')}}" accept-charset="UTF-8" class="form-horizontal" role="form">
				...
				<div class="form-group"> 
					<div class="col-sm-offset-2 col-sm-10">
						...
						<a href="{!! URL::action('BecaController@verSolicitud',$paso_beca->beca_id); !!}" class="btn btn-default">Cancel</a>
					</div>
				</div>	
